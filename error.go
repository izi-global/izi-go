...
<body>
    ...
    <div id="footer">
        <p>izigo {{ .IZIGoVersion }} (izigo framework)</p>
...
func showErr(err interface{}, ctx *context.Context, stack string) {
	t, _ := template.New("izigoerrortemp").Parse(tpl)
		...
		<div id="wrapper">
			<div id="container">
				...
				<div id="content">
					...
					<br>Powered by izigo {{.IZIGoVersion}}
				</div>
			</div>
		</div>
	</body>
...
func responseError(rw http.ResponseWriter, r *http.Request, errCode int, errContent string) {
	t, _ := template.New("izigoerrortemp").Parse(errtpl)
...
// usage:
// 	izigo.ErrorHandler("404",NotFound)
//	izigo.ErrorHandler("500",InternalServerError)
...
// usage:
// 	izigo.ErrorController(&controllers.ErrorController{})

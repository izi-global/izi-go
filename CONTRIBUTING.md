# Contributing to izigo

izigo is an open source project.
...
First of all. izigo follow the gitflow. So please send you pull request 
...
We're trying very hard to keep izigo simple and fast. We don't want it
...
issue](https://github.com/izi-global/izigo/issues) before anybody
starts working on it. 

Also when filing an issue, make sure to answer these five questions:

- What version of izigo are you using (izi version)?

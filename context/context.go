...
// Context Http request context struct including IZIGoInput, IZIGoOutput, http.Request and http.ResponseWriter.
// IZIGoInput and IZIGoOutput provides some api to operate request and response more easily.
type Context struct {
	Input          *IZIGoInput
	Output         *IZIGoOutput
...
// if izigo.ErrorMaps exists, panic body.
...
// It's alias of IZIGoInput.Cookie.
func (ctx *Context) GetCookie(key string) string {
	return ctx.Input.Cookie(key)
}

// SetCookie Set cookie for response.
// It's alias of IZIGoOutput.Cookie.

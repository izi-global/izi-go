...
import (
	...
	"github.com/izi-global/izigo/context/param"
	"github.com/izi-global/izigo/logs"
	"github.com/izi-global/izigo/toolbox"
...
var (
	...
	// these izigo.Controller's methods shouldn't reflect to AutoRouter
...
type FilterHandler interface {
	Filter(*izicontext.Context) bool
}
...
func (l *logFilter) Filter(ctx *izicontext.Context) bool {
...
func (p *ControllerRegister) addWithMethodParams(pattern string, c ControllerInterface, methodParams []*param.MethodParam, mappingMethods ...string) {
	...
	route.routerType = routerTypeIZIGo
...
// example izigo.AddAuto(&MainContorlller{}),
...
// example izigo.AddAutoPrefix("/admin",&MainContorlller{}),
// MainController has method List and Page.
...
func (p *ControllerRegister) geturl(t *Tree, url, controllName, methodName string, params map[string]string, httpMethod string) (bool, string) {
	...
	for _, l := range t.leaves {
		if c, ok := l.runObject.(*ControllerInfo); ok {
			if c.routerType == routerTypeIZIGo &&
...
func (p *ControllerRegister) execFilter(context *izicontext.Context, urlPath string, pos int) (started bool) {
...
func (p *ControllerRegister) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	context := p.pool.Get().(*izicontext.Context)
	context.Reset(rw, r)
...
func (p *ControllerRegister) handleParamResponse(context *izicontext.Context, execController ControllerInterface, results []reflect.Value) {
...
func (p *ControllerRegister) FindRouter(context *izicontext.Context) (routerInfo *ControllerInfo, isFind bool) {
...
func logAccess(ctx *izicontext.Context, startTime *time.Time, statusCode int) {

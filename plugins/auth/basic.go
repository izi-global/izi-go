...
//		izigo.InsertFilter("*", izigo.BeforeRouter,auth.Basic("username","secretpassword"))
//		izigo.Run()
//	}
//
//
...
//		return username == "diepdt" && password == "helloIZIGo"
//	}
//	authPlugin := auth.NewBasicAuthenticator(SecretAuth, "Authorization Required")
//	izigo.InsertFilter("*", izigo.BeforeRouter,authPlugin)
package auth

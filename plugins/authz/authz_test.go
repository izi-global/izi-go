...
import (
	...
	"github.com/izi-global/izigo/plugins/auth"
)

func testRequest(t *testing.T, handler *izigo.ControllerRegister, user string, path string, method string, code int) {
...
func TestBasic(t *testing.T) {
	handler := izigo.NewControllerRegister()

	handler.InsertFilter("*", izigo.BeforeRouter, auth.Basic("alice", "123"))
	handler.InsertFilter("*", izigo.BeforeRouter, NewAuthorizer(casbin.NewEnforcer("authz_model.conf", "authz_policy.csv")))
...
func TestPathWildcard(t *testing.T) {
	...
	handler.InsertFilter("*", izigo.BeforeRouter, auth.Basic("bob", "123"))
	handler.InsertFilter("*", izigo.BeforeRouter, NewAuthorizer(casbin.NewEnforcer("authz_model.conf", "authz_policy.csv")))
...
func TestRBAC(t *testing.T) {
	...
	handler.InsertFilter("*", izigo.BeforeRouter, auth.Basic("cathy", "123"))
	e := casbin.NewEnforcer("authz_model.conf", "authz_policy.csv")
	handler.InsertFilter("*", izigo.BeforeRouter, NewAuthorizer(e))

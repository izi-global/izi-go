...
//		"github.com/izi-global/izigo/plugins/apiauth"
//	)
//
//	func main(){
//		// apiauth every request
//		izigo.InsertFilter("*", izigo.BeforeRouter,apiauth.APIBaiscAuth("appid","appkey"))
//		izigo.Run()
//	}
//
// Advanced Usage:
...
//	}
//
//	izigo.InsertFilter("*", izigo.BeforeRouter,apiauth.APISecretAuth(getAppSecret, 360))
//
// Information:
//
...
func APIBaiscAuth(appid, appkey string) izigo.FilterFunc {
...
func APISecretAuth(f AppIDToAppSecret, timeout int) izigo.FilterFunc {
